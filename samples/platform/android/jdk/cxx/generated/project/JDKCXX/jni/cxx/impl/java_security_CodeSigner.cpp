...
java_security_CodeSigner::java_security_CodeSigner(JDKCXX::java_security_cert_CertPath const& arg0,JDKCXX::java_security_Timestamp const& arg1)
{
	LOGV("java_security_CodeSigner::java_security_CodeSigner(JDKCXX::java_security_cert_CertPath const& arg0,JDKCXX::java_security_Timestamp const& arg1) enter");	
	...
	LOGV("java_security_CodeSigner::java_security_CodeSigner(JDKCXX::java_security_cert_CertPath const& arg0,JDKCXX::java_security_Timestamp const& arg1) exit");	
}
...
// Functions
bool java_security_CodeSigner::equals(JDKCXX::java_lang_Object const& arg0)
{
	LOGV("bool java_security_CodeSigner::equals(JDKCXX::java_lang_Object const& arg0) enter");
	...
	LOGV("bool java_security_CodeSigner::equals(JDKCXX::java_lang_Object const& arg0) exit");

	return result;
}
JDKCXX::java_lang_String java_security_CodeSigner::toString()
{
	LOGV("JDKCXX::java_lang_String java_security_CodeSigner::toString() enter");
	...
	LOGV("JDKCXX::java_lang_String java_security_CodeSigner::toString() exit");
...
JDKCXX::java_security_cert_CertPath java_security_CodeSigner::getSignerCertPath()
{
	LOGV("JDKCXX::java_security_cert_CertPath java_security_CodeSigner::getSignerCertPath() enter");
	...
	LOGV("JDKCXX::java_security_cert_CertPath java_security_CodeSigner::getSignerCertPath() exit");

	return result;
}
JDKCXX::java_security_Timestamp java_security_CodeSigner::getTimestamp()
{
	LOGV("JDKCXX::java_security_Timestamp java_security_CodeSigner::getTimestamp() enter");
	...
	LOGV("JDKCXX::java_security_Timestamp java_security_CodeSigner::getTimestamp() exit");
