...
public:
	...
	virtual AndroidCXX::android_os_Handler * getHandler() ;
	...
	virtual int  getVerticalFadingEdgeLength() ;
	virtual void  setFadingEdgeLength(int const& arg0) ;
	virtual int  getHorizontalFadingEdgeLength() ;
	virtual int  getVerticalScrollbarWidth() ;
	virtual void  setVerticalScrollbarPosition(int const& arg0) ;
	virtual int  getVerticalScrollbarPosition() ;
	virtual void  setOnFocusChangeListener(AndroidCXX::android_view_View_OnFocusChangeListener const& arg0) ;
	virtual void  addOnLayoutChangeListener(AndroidCXX::android_view_View_OnLayoutChangeListener const& arg0) ;
	virtual void  removeOnLayoutChangeListener(AndroidCXX::android_view_View_OnLayoutChangeListener const& arg0) ;
	virtual void  addOnAttachStateChangeListener(AndroidCXX::android_view_View_OnAttachStateChangeListener const& arg0) ;
	virtual void  removeOnAttachStateChangeListener(AndroidCXX::android_view_View_OnAttachStateChangeListener const& arg0) ;
	virtual AndroidCXX::android_view_View_OnFocusChangeListener * getOnFocusChangeListener() ;
	...
	virtual void  setOnTouchListener(AndroidCXX::android_view_View_OnTouchListener const& arg0) ;
	...
	virtual AndroidCXX::android_view_accessibility_AccessibilityNodeInfo * createAccessibilityNodeInfo() ;
	virtual void  setAccessibilityDelegate(AndroidCXX::android_view_View_AccessibilityDelegate const& arg0) ;
	...
	virtual int  getLabelFor() ;
	virtual void  setLabelFor(int const& arg0) ;
	virtual bool  isFocused() ;
	virtual bool  isScrollContainer() ;
	virtual void  setScrollContainer(bool const& arg0) ;
	virtual int  getDrawingCacheQuality() ;
	virtual void  setDrawingCacheQuality(int const& arg0) ;
	virtual bool  getKeepScreenOn() ;
	virtual void  setKeepScreenOn(bool const& arg0) ;
	virtual int  getNextFocusLeftId() ;
	virtual void  setNextFocusLeftId(int const& arg0) ;
	virtual int  getNextFocusRightId() ;
	virtual void  setNextFocusRightId(int const& arg0) ;
	virtual int  getNextFocusUpId() ;
	virtual void  setNextFocusUpId(int const& arg0) ;
	virtual int  getNextFocusDownId() ;
	virtual void  setNextFocusDownId(int const& arg0) ;
	virtual int  getNextFocusForwardId() ;
	virtual void  setNextFocusForwardId(int const& arg0) ;
	...
	virtual void  setSoundEffectsEnabled(bool const& arg0) ;
	virtual bool  isSoundEffectsEnabled() ;
	virtual void  setHapticFeedbackEnabled(bool const& arg0) ;
	virtual bool  isHapticFeedbackEnabled() ;
	virtual void  setLayoutDirection(int const& arg0) ;
	virtual int  getLayoutDirection() ;
	virtual bool  hasTransientState() ;
	virtual void  setHasTransientState(bool const& arg0) ;
	virtual void  setWillNotDraw(bool const& arg0) ;
	virtual bool  willNotDraw() ;
	virtual void  setWillNotCacheDrawing(bool const& arg0) ;
	...
	virtual void  setPressed(bool const& arg0) ;
	virtual bool  isPressed() ;
	virtual bool  isSaveEnabled() ;
	virtual void  setSaveEnabled(bool const& arg0) ;
	virtual bool  getFilterTouchesWhenObscured() ;
	virtual void  setFilterTouchesWhenObscured(bool const& arg0) ;
	virtual bool  isSaveFromParentEnabled() ;
	virtual void  setSaveFromParentEnabled(bool const& arg0) ;
	virtual bool  isFocusable() ;
	virtual bool  isFocusableInTouchMode() ;
	virtual AndroidCXX::java_util_ArrayList * getFocusables(int const& arg0) ;
	virtual AndroidCXX::java_util_ArrayList * getTouchables() ;
	...
	virtual void  setTouchDelegate(AndroidCXX::android_view_TouchDelegate const& arg0) ;
	virtual AndroidCXX::android_view_TouchDelegate * getTouchDelegate() ;
	...
	virtual void  getDrawingRect(AndroidCXX::android_graphics_Rect const& arg0) ;
	virtual int  getMeasuredWidth() ;
	virtual int  getMeasuredWidthAndState() ;
	virtual int  getMeasuredHeight() ;
	virtual int  getMeasuredHeightAndState() ;
	virtual int  getMeasuredState() ;
	virtual AndroidCXX::android_graphics_Matrix * getMatrix() ;
	virtual float  getCameraDistance() ;
	virtual void  setCameraDistance(float const& arg0) ;
	virtual float  getRotation() ;
	virtual void  setRotation(float const& arg0) ;
	virtual float  getRotationY() ;
	virtual void  setRotationY(float const& arg0) ;
	virtual float  getRotationX() ;
	virtual void  setRotationX(float const& arg0) ;
	virtual float  getScaleX() ;
	virtual void  setScaleX(float const& arg0) ;
	virtual float  getScaleY() ;
	virtual void  setScaleY(float const& arg0) ;
	virtual float  getPivotX() ;
	virtual void  setPivotX(float const& arg0) ;
	virtual float  getPivotY() ;
	virtual void  setPivotY(float const& arg0) ;
	virtual float  getAlpha() ;
	virtual bool  hasOverlappingRendering() ;
	virtual void  setAlpha(float const& arg0) ;
	virtual int  getTop() ;
	virtual void  setTop(int const& arg0) ;
	virtual int  getBottom() ;
	virtual bool  isDirty() ;
	virtual void  setBottom(int const& arg0) ;
	virtual int  getLeft() ;
	virtual void  setLeft(int const& arg0) ;
	virtual int  getRight() ;
	virtual void  setRight(int const& arg0) ;
	virtual void  setX(float const& arg0) ;
	virtual void  setY(float const& arg0) ;
	virtual float  getTranslationX() ;
	virtual void  setTranslationX(float const& arg0) ;
	...
	virtual void  setVerticalFadingEdgeEnabled(bool const& arg0) ;
	virtual bool  isHorizontalScrollBarEnabled() ;
	virtual void  setHorizontalScrollBarEnabled(bool const& arg0) ;
	virtual bool  isVerticalScrollBarEnabled() ;
	virtual void  setVerticalScrollBarEnabled(bool const& arg0) ;
	virtual void  setScrollbarFadingEnabled(bool const& arg0) ;
	virtual bool  isScrollbarFadingEnabled() ;
	virtual int  getScrollBarDefaultDelayBeforeFade() ;
	virtual void  setScrollBarDefaultDelayBeforeFade(int const& arg0) ;
	virtual int  getScrollBarFadeDuration() ;
	...
	virtual int  getPaddingStart() ;
	virtual int  getPaddingRight() ;
	virtual int  getPaddingEnd() ;
	virtual bool  isPaddingRelative() ;
	virtual void  setSelected(bool const& arg0) ;
	virtual bool  isSelected() ;
	virtual void  setActivated(bool const& arg0) ;
	virtual bool  isActivated() ;
	virtual AndroidCXX::android_view_ViewTreeObserver * getViewTreeObserver() ;
	...
	virtual void  setMinimumHeight(int const& arg0) ;
	...
	virtual void  onWindowSystemUiVisibilityChanged(int const& arg0) ;
	virtual void  setOnSystemUiVisibilityChangeListener(AndroidCXX::android_view_View_OnSystemUiVisibilityChangeListener const& arg0) ;
