...
#define LOG_TAG "java_security_Principal"
...
bool java_security_Principal::equals(JDKCXX::java_lang_Object const& arg0)
{
	...
	LOGV("java_security_Principal jni address %d", javaObject);
...
JDKCXX::java_lang_String java_security_Principal::toString()
{
	LOGV("JDKCXX::java_lang_String java_security_Principal::toString() enter");
...
int java_security_Principal::hashCode()
{
	LOGV("int java_security_Principal::hashCode() enter");
...
JDKCXX::java_lang_String java_security_Principal::getName()
{
	LOGV("JDKCXX::java_lang_String java_security_Principal::getName() enter");
